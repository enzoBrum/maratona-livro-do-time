...
struct Vec {
  ...
  int dot(Vec const &o) { return x * o.x + y * o.y; }

  int cross(Vec const &o) { return y * o.x - x * o.y; }

  bool perpendicular(Vec const &o) { return dot(o) == 0; }

  bool parallel(Vec const &o) { return cross(o) == 0; }
};
...
struct Line {
  ...
  bool operator==(Line const &o) { return a == o.a && b == o.b && c == o.c; }
};

bool parallel(Line &l1, Line &l2) { return l1.a == l2.a && l1.b == l2.b; }
...
bool intersection(Line &l1, Line &l2, Point &out) {
  ...
  if (l1.b == 0)
    out.y = -(l2.a * out.x + l2.c); // vertical
  else
    out.y = -(l1.a * out.x + l1.c);
  return true;
}
...
struct Segment {
  ...
  bool intersects(Segment &o) {
    ...
    if (o1 == 0 && overlaps(o.p1))
      return true;
    if (o2 == 0 && overlaps(o.p2))
      return true;
    if (o3 == 0 && o.overlaps(p1))
      return true;
    if (o4 == 0 && o.overlaps(p2))
      return true;
    return false;
  }

  double length() { return p1.dist(p2); }
};
